...
def main(args):
    ...
    if accelerator.is_main_process:
        if args.use_lora:
            ...
            print("Saved unet to", os.path.join(args.output_dir, "unet"))
            if args.train_text_encoder:
                print("Saving text encoder to", os.path.join(args.output_dir, "text_encoder"))
                ...
                print("Saved11 text encoder to", os.path.join(args.output_dir, "text_encoder"))
        else:
            pipeline = DiffusionPipeline.from_pretrained(
                args.pretrained_model_name_or_path,
